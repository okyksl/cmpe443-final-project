...
// P1.23 (P6) - Left Motor Enable
#define PWM_MOTOR_L_MR MR4
#define PWM_MOTOR_L_CHANNEL 4
#define IOCON_MOTOR_L_FUNC 0x2
#define IOCON_MOTOR_L_ADDRESS 0x4002C0DC
#define IOCON_MOTOR_L *((volatile uint32_t*)(IOCON_MOTOR_L_ADDRESS))

// P1.24 (P5) - Right Motor Enable
#define PWM_MOTOR_R_MR MR5
#define PWM_MOTOR_R_CHANNEL 5
#define IOCON_MOTOR_R_FUNC 0x2
#define IOCON_MOTOR_R_ADDRESS 0x4002C0E0
#define IOCON_MOTOR_R *((volatile uint32_t*)(IOCON_MOTOR_R_ADDRESS))

// P5.2 (P32) and P5.3 (P31) - Left Motor Ins
#define GPIO_MOTOR_L_PORT_A PORT5
#define GPIO_MOTOR_L_PIN_A 2
#define GPIO_MOTOR_L_PORT_B PORT5
#define GPIO_MOTOR_L_PIN_B 3

// P1.20 (P7) and P0.21 (P8) - Right Motor Ins
#define GPIO_MOTOR_R_PORT_A PORT1
#define GPIO_MOTOR_R_PIN_A 20
